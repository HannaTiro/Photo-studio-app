...
namespace PhotoStudio.Mapping
{
    public class PhotoStudioProfile : Profile
    {
        public PhotoStudioProfile()
        {
            ...
            CreateMap<PhotoStudio.Database.Usluga, Data.Model.Usluga>().ReverseMap();
            CreateMap<PhotoStudio.Database.Oprema, Data.Model.Oprema>().ReverseMap();
           ...
           CreateMap<RejtingRequest, KorisnikRequest>().ReverseMap();
            ...
            //Usluga
            CreateMap<Usluga, UslugaUpsert>().ReverseMap();
            CreateMap<UslugaRequest, UslugaSearchRequest>().ReverseMap();
            CreateMap<Database.Usluga, UslugaRequest>().ReverseMap();



            //Oprema
            CreateMap<Oprema, OpremaUpsert>().ReverseMap();
            CreateMap<OpremaRequest, OpremaSearchRequest>().ReverseMap();
            CreateMap<Database.Oprema, OpremaRequest>().ReverseMap();
